...
public class HuaweiGameServicesManager : MonoBehaviour
{
    ...
    public class MyGetLeaderboardScoresListener : IGetLeaderboardScoresListener
    {
        public void OnSuccess(LeaderboardScores leaderboardScores)
        {
            ...
            {
                Debug.Log("get succeed, but leaderboardScores == null");
                return;
            }
            ...
            Debug.Log(msg);
            //ServiceLocator.leaderboardsManager.SetLeaderboardScores(leaderboardScoreDataList);
        }
    ...
    public class MyGetLeaderboardScoreListener : IGetLeaderboardScoreListener
    {
        public void OnSuccess(LeaderboardScore score)
        {
            ...
            Log(msg);
            //ServiceLocator.leaderboardsManager.SetCurrentPlayerLeaderboardScore(currentPlayerScores);
        }
